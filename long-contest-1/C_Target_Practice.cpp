        ...
        f1(j, 10)
        {
            ...
            if (c == 'X')
            {
                if (i == 1 || i == 10 || j == 1 || j == 10)
                    points++;
                else if ((i == 2 && j > 1 && j < 10) || (i == 9 && j > 1 && j < 10) || (j == 2 && i > 1 && i < 10) || (j == 9 && i > 1 && i < 10))
                    points += 2;

                else if ((i == 3 && j > 2 && j < 9) || (i == 8 && j > 2 && j < 9) || (j == 3 && i > 2 && i < 9) || (j == 8 && i > 2 && i < 9))
                    points += 3;

                else if ((i == 4 && j > 3 && j < 8) || (i == 7 && j > 3 && j < 8) || (j == 4 && i > 3 && i < 8) || (j == 7 && i > 3 && i < 8))
                    points += 4;
